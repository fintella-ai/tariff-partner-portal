...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Sidebar */}
      <div className="w-60 theme-sidebar border-r p-4 flex flex-col gap-1 shrink-0 sticky top-0 h-screen overflow-y-auto">
        ...
        <div className="pt-4 px-2 mt-4" style={{ borderTop: "1px solid var(--app-border)" }}>
