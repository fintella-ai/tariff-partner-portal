...
export default auth((req) => {
  ...
  if (pathname.startsWith("/docs/") || pathname.startsWith("/signup") || pathname.startsWith("/impersonate") || pathname.startsWith("/getstarted") || pathname === "/privacy" || pathname === "/terms" || pathname === "/forgot-password" || pathname === "/reset-password" || pathname === "/apply" || pathname === "/booker" || pathname === "/landing-v2" || pathname.startsWith("/recover")) {
