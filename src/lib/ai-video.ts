    ...
    scenes: [
      ...
      },
      {
        ...
        bullets: [
          ...
          '"We don\'t have time" — Frost Law handles everything',
        ],
        narration:
      ...
      },
      {
        ...
        bullets: [
          ...
          "Client receives a guided intake from Frost Law",
        ],
        narration:
          "When your prospect is ready, submit them through the portal or share your referral link. Frost Law takes it from there — scheduling consultations, collecting documents, and filing the claim.",
        durationSec: 20,
        visualHint: "📋",
      },
      {
