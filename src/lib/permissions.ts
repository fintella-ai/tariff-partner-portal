...
export const ROLE_VISIBLE_NAV: Record<AdminRole, string[]> = {
  super_admin: ["partners", "deals", "communications", "training", "conference", "documents", "support", "payouts", "revenue", "reports", "settings", "users"],
  admin: ["partners", "deals", "communications", "training", "conference", "documents", "support", "payouts", "reports", "settings"],
  accounting: ["deals", "documents", "payouts", "revenue", "reports"],
  partner_support: ["partners", "deals", "communications", "training", "conference", "documents", "support", "payouts", "settings"],
};
