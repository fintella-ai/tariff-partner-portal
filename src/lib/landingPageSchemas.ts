...
export const DEFAULT_BROKERS: BrokersPageContent = {
  ...
  hero: {
    ...
    bullets: [
      ...
      { icon: "⚡", title: "Fast-cash buyout option", description: "Clients can sell their accepted claim for 65–85 cents on the dollar and get paid in weeks, not months. You still earn your commission." },
    ],
  },
  whyPartner: {
    ...
    features: [
      ...
      { icon: "⚡", title: "Claim Buyout for Clients", description: "After a claim is accepted, your client can opt to sell it for 65–85 cents on the dollar and receive funds in weeks instead of waiting months for CBP processing. You still earn your full referral commission on the deal." },
